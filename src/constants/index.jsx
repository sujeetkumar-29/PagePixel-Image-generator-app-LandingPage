export const features = [
  {
    ...
    text: "With PagePixel, creative blocks are history. Smart image generation and effortless design tools bring your projects to life in no time. It’s like having a personal artist on call—without the wait.",
    button: {
  ...
  },
  {
    ...
    text: "Your creative work is safe with us. With cutting-edge encryption and strong privacy protections, PagePixel keeps your images and data locked down tighter than Fort Knox.",
    button: {
...
export const details = [
  {
    ...
    title: "Turning your footage into polished content in seconds.",
  },
  {
    id: "1",
...
export const faq = [
  {
    id: "0",
    question: "How easy is it to setup PagePixel?",
    answer:
...
export const testimonials = [
  {
    ...
    comment:
      "PagePixel’s customer support is top-notch—like having tech superheroes on standby whenever you need help.",
  },
  {
    id: "1",
    name: "Mark Erixon",
  ...
  },
  {
    ...
    comment:
      "Switched to PagePixel last month, and our creative workflow has never been smoother. Best decision for our team!",
  },
  {
    id: "5",
    name: "Jim Bradley",
